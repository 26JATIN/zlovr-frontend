...
const DEFAULT_GLOW_COLOR = "255, 105, 135"; // Heart-inspired pink/red color
...
const cardData = [
	{
		...
		description:
			"Our advanced algorithm analyzes 32+ compatibility factors to find your perfect match.",
		label: "AI Powered",
		image:
	...
	},
	{
		...
		description:
			"Every profile is manually verified with photo verification and background checks.",
		label: "Security",
		image:
	...
	},
	{
		...
		description:
			"End-to-end encrypted conversations with advanced privacy controls.",
		label: "Privacy",
		image:
			"https://images.unsplash.com/photo-1611746869696-d09bce200020?q=80&w=400&auto=format&fit=crop",
	},
	{
		color: "#060010",
		title: "Relationship Goals",
		description:
			"Filter by what you're seeking - from casual dates to serious relationships.",
		label: "Matching",
		image:
	...
	},
	{
		...
		label: "Discovery",
		image:
			"https://images.unsplash.com/photo-1569025743873-ea3a9ade89f9?q=80&w=400&auto=format&fit=crop",
	},
	{
		color: "#060010",
		title: "Premium Experience",
		description:
			"Unlimited likes, super boosts, and priority customer support.",
		label: "Premium",
		image:
	...
	return (
		<>
          ...
          .bento-section {
            ...
            --white: hsl(0, 0%, 100%);
            --heart-primary: rgba(255, 105, 135, 1);
            --heart-glow: rgba(255, 105, 135, 0.15);
            --heart-border: rgba(255, 105, 135, 0.6);
          }
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(255, 105, 135, 0.2), 0 0 30px rgba(${glowColor}, 0.1);
          }
          ...
          .particle-container:hover {
            box-shadow: 0 4px 20px rgba(255, 105, 135, 0.1), 0 0 30px rgba(${glowColor}, 0.1);
          }
							...
							return (
								...
								>
									...
									<div className="card__header flex justify-between gap-3 relative text-white z-10">
										<span className="card__label text-base bg-white/20 px-3 py-1 rounded-full backdrop-blur-sm">{card.label}</span>
									</div>
